...
Tech Stack
Backend: Python, FastAPI, SQLAlchemy, PostgreSQL, Pandas
Frontend: React (Vite), Recharts
Dev & Ops: Docker, Docker Compose, Pytest

Architecture
CSV Data → PostgreSQL → FastAPI → React Dashboard

Screenshots
(Add your screenshots in GitHub under screenshots/ folder and link them like:
